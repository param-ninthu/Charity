       ...
       />
            <View style={{margin:20}}>
                <View style={{alignItems:'center'}}>
                    ...
                    <Text style={{marginTop:15,fontSize:18,fontWeight:'bold'}}>HelpHand</Text>
                </View>
                ...
                <View style={styles.action}>
                    <FontAwesome name="at" size={20} color={colors.text}/>
                    <TextInput
                ...
                <View style={styles.action}>
                    <FontAwesome name="mobile" size={20} color={colors.text}/>
                    <TextInput
