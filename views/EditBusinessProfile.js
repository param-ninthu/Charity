...
const EditBusinessProfile =({navigation}) =>{
    ...
    return (
        <View style={[styles.container],{marginTop:15,backgroundColor:'white'}}>
           <Image 
              source={require('./../assets/backgroundfilters/bg7.jpg')}
              style={{position:'absolute',zIndex:-1,top:180,left:150}}
              />
            <View style={{margin:20}}>
                <View style={{alignItems:'center'}}>
                    ...
                    <Text style={{marginTop:15,fontSize:18,fontWeight:'bold'}}>UniLiver</Text>
                </View>
                ...
                <TouchableOpacity style={styles.commandButton} onPress={bussprofile}>
