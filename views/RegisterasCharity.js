...
const CharitySignUpScreen = ({navigation}) => {
  const Charityhome = () =>{
    navigation.navigate('CharityPage')
  }
       ...
       />
        ...
        <View style={{marginTop: 20}}>
          ...
          <FontAwesome name="building-o" size={24} color={COLORS.blue}  />
            <TextInput placeholder="Charity-Name" style={STYLES.input} />
          </View>

          <View style={STYLES.inputContainer}>
          <FontAwesome name="registered" size={24} color={COLORS.blue} />
            <TextInput
              placeholder="Charity Register No"
              style={[STYLES.input]}
            />
          </View>
          <View style={STYLES.inputContainer}>
          <Feather name="calendar" size={24} color={COLORS.blue} />
            <TextInput
              placeholder="Charity Registered Date"
              style={[STYLES.input]}
            />
          </View>
        ...
        <TouchableOpacity onPress={Charityhome}>
          <View style={{alignItems:'center'}}>
...
export default CharitySignUpScreen;