...
const VolunteerEvents =({navigation}) =>{
    return(
        <SafeAreaView style={styles.container}>
           <ScrollView> 
            ...
            <View style={{flexDirection:'column'}}>       
                ...
                <View style={{borderRadius:5,backgroundColor:COLORS.blue,alignItems:'center',justifyContent:'center',height:25,width:60,left:320,top:5}}>
                    <TouchableOpacity> 
            ...
            <View style={{flexDirection:'column'}}>            
                ...
                <View style={{borderRadius:5,backgroundColor:COLORS.blue,alignItems:'center',justifyContent:'center',height:25,width:60,left:320,top:-45}}>
                    <TouchableOpacity> 
                        <Text style={{color:'white',fontWeight:'bold',fontSize:16}}>
                            Join
                        </Text>
